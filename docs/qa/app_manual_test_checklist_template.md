...
| P0-10 | 点击「手账」 | 点击底部「手账」 | 进入手账列表占位页（JournalListScreen） | [ ] |
...
| # | 测试项 | 步骤 | 预期结果 | 通过 |
|---|--------|------|----------|------|
| H-1 | 手账页可打开 | 点击底部「手账」 | 显示手账列表占位页（P2 未完成时为占位或空状态） | [ ] |
...
| 日期 | 修订内容 |
|------|----------|
| {{REVISION_DATE}} | 根据最新项目进度审查记录与交付清单生成，供本轮人工测试使用。 |

---

*本文档由 [qa-manual-test-workflow](../../.cursor/commands/qa-manual-test-workflow.md) 根据模板生成；P2 手帐核心完成后可增补「手账 CRUD」「块编辑」「插入工具结果」等人工测试条目。*
